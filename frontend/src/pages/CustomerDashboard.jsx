  ...
  return (
    <div className="min-h-screen w-full bg-slate-950 text-slate-100 flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="z-10 flex flex-col items-center gap-6 glass p-12 rounded-3xl border border-slate-800">
        <div className="w-20 h-20 bg-orange-600 rounded-2xl flex items-center justify-center shadow-lg shadow-orange-500/25">
          <Smile className="w-10 h-10 text-white" />
        </div>
        
        <div className="text-center">
          <h1 className="text-3xl font-black text-white tracking-tight">Customer Login Successful</h1>
          <p className="text-slate-400 mt-2 max-w-md">
            You have successfully authenticated as a Customer. This module handles Authentication.
          </p>
        </div>
